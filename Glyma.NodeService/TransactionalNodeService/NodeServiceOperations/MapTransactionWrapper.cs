...
namespace TransactionalNodeService
{
    ...
    public class MapTransactionWrapper : IPersistableSessionObject, IMapTransaction
    {
        ...
        public MapParameter DomainParameter
        {
            get
            {
                if (_domainParameter == null)
                {
                    ...
                    {
                        _domainParameter = MapObjects.Parameters[Core.DomainParameterUid.Value];
                    }
                }
        ...
        public MapParameter RootMapParameter
        {
            get
            {
                if (_rootMapParameter == null)
                {
                    ...
                    {
                        _rootMapParameter = MapObjects.Parameters[Core.RootMapParameterUid.Value];
                    }
                }
        ...
        public MapParameter NodeParameter
        {
            get
            {
                if (_nodeParameter == null)
                {
                    ...
                    {
                        _nodeParameter = MapObjects.Parameters[Core.NodeParameterUid.Value];
                    }
                }
        ...
        public MapParameter RelationshipParameter
        {
            get
            {
                if (_relationshipParameter == null)
                {
                    ...
                    {
                        _relationshipParameter = MapObjects.Parameters[Core.RelationshipParameterUid.Value];
                    }
                }
        ...
        public MapParameter DescriptorParameter
        {
            get
            {
                if (_descriptorParameter == null)
                {
                    ...
                    {
                        _descriptorParameter = MapObjects.Parameters[Core.DescriptorParameterUid.Value];
                    }
                }
        ...
        public MapParameter MetadataParameter
        {
            get
            {
                if (_metadataParameter == null)
                {
                    ...
                    {
                        _metadataParameter = MapObjects.Parameters[Core.MetadataParameterUid.Value];
                    }
                }
        ...
        public MapParameter ResponseParameter
        {
            get
            {
                if (_responseParameter == null)
                {
                    ...
                    {
                        _responseParameter = MapObjects.Parameters.AddParameter(ResponseParameterType, Guid.Empty, true);
                        Core.ResponseParameterUid = _responseParameter.Id;
                    }
                    else
                    {
                        _responseParameter = MapObjects.Parameters[Core.ResponseParameterUid.Value];
                    }
                }
        ...
        public void ExecuteOperation(ref MapResponse response)
        {
            ...
            {
                OperationEngine.ExecuteTransaction(MapObjects.MapDbConnection, this, ref response);
            }
        }
