...
namespace Glyma.Powershell.Update.v1_5_0_r3.MappingTool
{
    ...
    partial void DeleteRelationshipType(RelationshipType instance);
		...
		public MappingToolDatabaseDataContext() : 
				base(global::Glyma.Powershell.Update.Properties.Settings.Default.SP2013_Map_GlymaDBConnectionString1, mappingSource)
		{
			OnCreated();
		}
	...
	public partial class AuditLog : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<int> _MaxDepth;
		
		private System.Nullable<int> _ObjectIndex;
		
		private string _EdgeConditions;
		
		private string _FilterConditions;
    ...
    partial void OnCallingUrlChanging(string value);
    partial void OnCallingUrlChanged();
    ...
    partial void OnMaxDepthChanging(System.Nullable<int> value);
    partial void OnMaxDepthChanged();
    partial void OnObjectIndexChanging(System.Nullable<int> value);
    partial void OnObjectIndexChanged();
    partial void OnEdgeConditionsChanging(string value);
    partial void OnEdgeConditionsChanged();
    partial void OnFilterConditionsChanging(string value);
    partial void OnFilterConditionsChanged();
    partial void OnSearchConditionsChanging(string value);
    partial void OnSearchConditionsChanged();
    ...
    partial void OnUserChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_CallingUrl", DbType="NVarChar(255)")]
		public string CallingUrl
		{
			...
			set
			{
				if ((this._CallingUrl != value))
				{
					this.OnCallingUrlChanging(value);
					this.SendPropertyChanging();
					this._CallingUrl = value;
					this.SendPropertyChanged("CallingUrl");
					this.OnCallingUrlChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_MaxDepth", DbType="Int")]
		public System.Nullable<int> MaxDepth
		{
			get
			{
			...
			set
			{
				if ((this._MaxDepth != value))
				{
					this.OnMaxDepthChanging(value);
					this.SendPropertyChanging();
					this._MaxDepth = value;
					this.SendPropertyChanged("MaxDepth");
					this.OnMaxDepthChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ObjectIndex", DbType="Int")]
		public System.Nullable<int> ObjectIndex
		{
			get
			{
			...
			set
			{
				if ((this._ObjectIndex != value))
				{
					this.OnObjectIndexChanging(value);
					this.SendPropertyChanging();
					this._ObjectIndex = value;
					this.SendPropertyChanged("ObjectIndex");
					this.OnObjectIndexChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_EdgeConditions", DbType="NVarChar(MAX)")]
		public string EdgeConditions
		{
			get
			{
				return this._EdgeConditions;
			}
			set
			{
				if ((this._EdgeConditions != value))
				{
					this.OnEdgeConditionsChanging(value);
					this.SendPropertyChanging();
					this._EdgeConditions = value;
					this.SendPropertyChanged("EdgeConditions");
					this.OnEdgeConditionsChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_FilterConditions", DbType="NVarChar(MAX)")]
		public string FilterConditions
		{
			...
			set
			{
				if ((this._FilterConditions != value))
				{
					this.OnFilterConditionsChanging(value);
					this.SendPropertyChanging();
					this._FilterConditions = value;
					this.SendPropertyChanged("FilterConditions");
					this.OnFilterConditionsChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_SearchConditions", DbType="NVarChar(MAX)")]
		public string SearchConditions
		{
			...
			set
			{
				if ((this._SearchConditions != value))
				{
					this.OnSearchConditionsChanging(value);
					this.SendPropertyChanging();
					this._SearchConditions = value;
					this.SendPropertyChanged("SearchConditions");
