...
namespace Glyma.Powershell.SharePoint
{
	...
	public partial class SecurityDatabaseDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void InsertSecurableContextDatabase(SecurableContextDatabase instance);
    partial void UpdateSecurableContextDatabase(SecurableContextDatabase instance);
    partial void DeleteSecurableContextDatabase(SecurableContextDatabase instance);
    ...
    partial void DeleteSecurableContext(SecurableContext instance);
		...
		public SecurityDatabaseDataContext() : 
				base(global::Glyma.Powershell.SharePoint.Properties.Settings.Default.Development_Security_GlymaDBConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public SecurityDatabaseDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public SecurityDatabaseDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public SecurityDatabaseDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public SecurityDatabaseDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<SecurableContextDatabase> SecurableContextDatabases
		{
			get
			{
				return this.GetTable<SecurableContextDatabase>();
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.SecurableContextDatabases")]
	public partial class SecurableContextDatabase : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnDatabaseNameChanged();
		...
		public SecurableContextDatabase()
		{
			this._SecurableContext = default(EntityRef<SecurableContext>);
			OnCreated();
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_SecurableContextId", DbType="Int NOT NULL", IsPrimaryKey=true)]
		public int SecurableContextId
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_DatabaseName", DbType="NVarChar(100) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="SecurableContext_SecurableContextDatabase", Storage="_SecurableContext", ThisKey="SecurableContextId", OtherKey="SecurableContextId", IsForeignKey=true)]
		public SecurableContext SecurableContext
		{
			get
			{
			...
			set
			{
							...
							|| (this._SecurableContext.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._SecurableContext.Entity = null;
						previousValue.SecurableContextDatabases.Remove(this);
					}
					this._SecurableContext.Entity = value;
					if ((value != null))
					{
						value.SecurableContextDatabases.Add(this);
						this._SecurableContextId = value.SecurableContextId;
					}
					else
					{
	...
	public partial class SecurableContext : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<SecurableContextDatabase> _SecurableContextDatabases;
    ...
    partial void OnSiteSPIDChanged();
		...
		public SecurableContext()
		{
			...
			this._SecurableContextDatabases = new EntitySet<SecurableContextDatabase>(new Action<SecurableContextDatabase>(this.attach_SecurableContextDatabases), new Action<SecurableContextDatabase>(this.detach_SecurableContextDatabases));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="SecurableContext_SecurableContextDatabase", Storage="_SecurableContextDatabases", ThisKey="SecurableContextId", OtherKey="SecurableContextId")]
		public EntitySet<SecurableContextDatabase> SecurableContextDatabases
		{
			get
			{
				return this._SecurableContextDatabases;
			}
			set
			{
				this._SecurableContextDatabases.Assign(value);
			}
		}
		...
		private void attach_SecurableContextDatabases(SecurableContextDatabase entity)
		{
			this.SendPropertyChanging();
			entity.SecurableContext = this;
		}
		
		private void detach_SecurableContextDatabases(SecurableContextDatabase entity)
		{
			this.SendPropertyChanging();
			entity.SecurableContext = null;
		}
