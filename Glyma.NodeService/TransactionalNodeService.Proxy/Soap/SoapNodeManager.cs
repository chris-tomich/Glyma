...
{
    internal class SoapNodeManager : Proxy.INodeFactory
    {
        private Dictionary<Guid, Proxy.INode> _proxyNodes = null;
        ...
        private IDictionary<Guid, Proxy.INode> ProxyNodes
        {
            get
            {
                if (_proxyNodes == null)
                {
                    _proxyNodes = new Dictionary<Guid, Proxy.INode>();
                }
