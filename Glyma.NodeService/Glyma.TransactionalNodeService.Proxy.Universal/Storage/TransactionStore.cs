...
namespace TransactionalNodeService.Proxy.Universal.Storage
{
    public class TransactionStore : IDisposable
    {
        ...
        private Queue<TransactionChain> _transactionChains = null;
        ...
        private Queue<TransactionChain> TransactionChains
        {
            get
            {
                if (_transactionChains == null)
                {
                    _transactionChains = new Queue<TransactionChain>();
                }
        ...
        public TransactionChain CurrentChain
        {
            get;
            private set;
        }
