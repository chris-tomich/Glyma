...
namespace TransactionalNodeService.Proxy.Universal.Soap.TransactionFramework
{
    public class DeleteMetadataTransactionLink : ISoapTransactionLink, ISoapTransactionLinkExecutor
    {
        ...
        DependencyCollection ISoapTransactionLinkExecutor.UpdateDependencies()
        {
            ...
            IFacade iFacadeMetadata = Metadata as IFacade;

            if (iFacadeMetadata != null)
            {
                if (!iFacadeMetadata.IsConcrete)
                {
                    FacadeMetadataSet facadeMetadata = iFacadeMetadata as FacadeMetadataSet;
        ...
        void ISoapTransactionLinkExecutor.ExecuteTransaction(Guid sessionId, TransactionalMappingToolServiceClient serviceProxy)
        {
            ...
            ServiceProxy.MDCompleted += OnDeleteMetadataCompleted;
            ServiceProxy.MDAsync(CallingUrl.Url, SessionId, DomainParameter.GetParameterValue(sessionId), MetadataParameter.GetParameterValue(sessionId), this);
        }
